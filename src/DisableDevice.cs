...
public class RemoveDisableDevicesPatch
{
    ...
    public static void UpdateDisableDevices()
    {
        ...
        bool ignore = player.GetCustomRole() is GM ||
                      player.Data.IsDead /*||
                ...
                (OldOptions.DisableDevicesIgnoreAfterAnyoneDied.GetBool() && GameStates.AlreadyDied)#1#;
        ...
        {
            case 0:
                if (StaticOptions.DisableSkeldAdmin.GetBool())
