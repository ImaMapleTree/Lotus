...
public class CustomOptionBar: MonoBehaviour
{
    ...
    public CustomOptionBar(IntPtr intPtr) : base(intPtr)
    {
        ...
        GeneralSettings.GetComponentInChildren<SpriteRenderer>().sprite = AssetLoader.LoadSprite("Lotus.assets.Settings.GeneralButton.png", ButtonPpu);

        DisplaySettings = gameObject.AddComponent<PassiveButton>();
        DisplaySettings.GetComponentInChildren<SpriteRenderer>().sprite = AssetLoader.LoadSprite("Lotus.assets.Settings.GraphicsButton.png", ButtonPpu);

        SoundSettings = gameObject.AddComponent<PassiveButton>();
        SoundSettings.GetComponentInChildren<SpriteRenderer>().sprite = AssetLoader.LoadSprite("Lotus.assets.Settings.SoundButton.png", ButtonPpu);

        VentLibSettings = gameObject.AddComponent<PassiveButton>();
        VentLibSettings.GetComponentInChildren<SpriteRenderer>().sprite = AssetLoader.LoadSprite("Lotus.assets.Settings.VentButton.png", 300);

        AddonSettings = gameObject.AddComponent<PassiveButton>();
        AddonSettings.GetComponentInChildren<SpriteRenderer>().sprite = AssetLoader.LoadSprite("Lotus.assets.Settings.AddonButton.png", ButtonPpu);
