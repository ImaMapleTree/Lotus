...
public class CustomNameMenu
{
    ...
    public class CustomNameMenuRegister
    {
        ...
        private static void AddButtons()
        {
            ...
            left.Background.sprite = Utils.LoadSprite("Lotus.assets.NameMenu.ArrowLeft.png", 100f);
            ...
            right.Background.sprite = Utils.LoadSprite("Lotus.assets.NameMenu.ArrowRight.png", 100f);
            ...
            visibility.Background.sprite = Utils.LoadSprite("Lotus.assets.NameMenu.Visibility.png", 100f);
            ...
            up.Background.sprite = Utils.LoadSprite("Lotus.assets.NameMenu.ArrowUp.png", 100f);
            ...
            down.Background.sprite = Utils.LoadSprite("Lotus.assets.NameMenu.ArrowDown.png", 100f);
            ...
            zoomIn.Background.sprite = Utils.LoadSprite("Lotus.assets.NameMenu.ZoomIn.png", 100f);
            ...
            zoomOut.Background.sprite = Utils.LoadSprite("Lotus.assets.NameMenu.ZoomOut.png", 100f);
            ...
            addSpace.Background.sprite = Utils.LoadSprite("Lotus.assets.NameMenu.AddSpace.png", 100f);
            ...
            removeSpace.Background.sprite = Utils.LoadSprite("Lotus.assets.NameMenu.RemoveSpace.png", 100f);
